...
These examples assume that [`skn` is installed](README.md#installation-and-basic-setup)
and that [`SKN_PATH_CHECK` is configured](USAGE.md#installation-and-setup).
